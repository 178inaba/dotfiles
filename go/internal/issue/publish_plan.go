...
type PublishPlan struct {
	...
	// fill-in of an issue this run creates whose body goes out holding a
	// forward reference. The same keys the result reports as edited. A
	// target's title and labels go out with its body.
