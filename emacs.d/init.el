...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (elixir-mode git-gutter+ csharp-mode lua-mode yaml-mode web-mode typescript-mode toml-mode sql-indent php-mode php-completion perl6-mode nginx-mode markdown-mode json-mode js2-mode go-mode go-eldoc gitconfig-mode flycheck editorconfig dockerfile-mode coffee-mode auto-complete))))
(custom-set-faces
